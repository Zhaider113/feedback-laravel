...
<head>
    ...
    <link rel="stylesheet" href="{{asset('theme/user/style/style.css')}}">
    <link rel="stylesheet" href="{{asset('theme/user/bootstrap/css/bootstrap.css')}}">
...
<script src="{{asset('theme/user/JavaScript/main.js')}}"></script>
<script src="{{asset('theme/user/bootstrap/js/bootstrap.js')}}"></script>
