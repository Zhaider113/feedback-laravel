                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-primary text-white mb-4">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="{{ route ('admin.users.index')}}" style="text-decoration: none;">View Details</a>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-warning text-white mb-4">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="{{ route ('admin.products.index')}}" style="text-decoration:none">View Details</a>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{$count_products}}
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-warning text-white mb-4">
                            <div class="card-body">Product Reviews</div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="{{ route ('admin.reviews.index')}}" style="text-decoration:none">View Details</a>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{$count_reviews}}
                                </div>
                            </div>
